...
package org.wso2.ts.integration.ui.pages;
...
public class TSIntegrationUiBaseTest {

    private static final Log log = LogFactory.getLog(TSIntegrationUiBaseTest.class);
    protected AutomationContext automationContext;

    protected void init() throws IOException, XMLStreamException, XPathExpressionException {
        automationContext = new AutomationContext("TS", "ts001", TestUserMode.SUPER_TENANT_ADMIN);
    }
